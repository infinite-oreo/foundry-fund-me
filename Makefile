...
# SENDER_ADDRESS: 用于 fund/withdraw 脚本，设置为你的钱包地址，例如 Anvil 默认第一个账户
# 在 .env 中设置 SENDER_ADDRESS=0xYourAddress 或直接修改此处
SENDER_ADDRESS := $(or $(SENDER_ADDRESS), 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266)
